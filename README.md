# Learn-Unlearn-Relearn-Noise-SSMs

> **Extension of [Learn-Unlearn-Relearn-Noise-SLMs](https://github.com/quest-lab-iisc/Learn-Unlearn-Relearn-Noise-SLMs) to State Space Models (SSMs)**

This project extends the QUEST Lab (IISc) paper to compare how **Mamba (SSM)** architectures handle noise patterns compared to Transformers.

### Research Questions

1. Do SSMs learn noise patterns faster or slower than Transformers?
2. Do SSMs retain noise more persistently after clean retraining?
3. Does the recurrent hidden state make SSMs more/less susceptible to different noise types?
...
Learn-Unlearn-Relearn-Noise-SSMs/
├── mamba/                               # NEW: Mamba SSM implementation
│   ├── configs/                         # configuration files for Mamba
│   ├── src/                             # source code specific to Mamba
│   ├── inference.py                     # inference script for Mamba model
│   └── train.py                         # training script for Mamba model
├── assets/
...
This project builds upon the excellent work by QUEST Lab (IISc). Please cite the original paper:
...
- [Original Paper](https://arxiv.org/abs/2407.00996)
- [Original Repository](https://github.com/quest-lab-iisc/Learn-Unlearn-Relearn-Noise-SLMs)
